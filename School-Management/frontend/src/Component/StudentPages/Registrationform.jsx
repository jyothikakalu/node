    ...
    //  console.log(studentData)
     const submitHandler = async (e) => {
        ...
        if (!fname || !lname || !email || !password || !mobile || !sId) {
          ...
          let res = await fetch("http://127.0.0.1:4000/student/signup", {
            method: "POST",
                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form class="space-y-4 md:space-y-6" action="#" onSubmit={(e)=>{
                                ...
                                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                   ...
                                   <Link to="/studentLogin"><a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</a></Link>
                                </p>
                            </form>
                        </div>
                    </div>
